...
enum STRUCTURE_FIELDS {StructureName, StructureHeight, StructureWidth, StructureDepth, StructureDescription, StructureModel, StructureIcon, GroundBefore, GroundAfter, InitialHappiness, MaxStructures, UnlockedBy, MaterialCost, Requirements, DaysToComplete, Electricity, Water, Food, Waste, Soil, Happiness}
...
Bush (flowers)	2.5	2	2	TBD	apple_tree2.tscn	0,0	1	2	2		Seeds	0		1			1			0
Compost bin	1	2	2	Compost bin or area with regenerative farming tools	composting_regen_agriculture.tscn	3,0	0	2	1	5	Contractor	2		1				-1	1	0
...
Raised bed	0.5	6	6	Somewhere to plant stuff	raised_bed.tscn	0,0	0	1	1	25	Contractor	3		1						0
...
Tree	2.5	2	2	Fruit-bearing trees or bushes	apple_tree2.tscn	0,0	1	2	2		Seeds	0		1			1			0
Vegetables	0.5	1	1	Small garden bed for growing vegetables	vegetables.tscn	0,0	1	2	2		Seeds	0		1			1			0"""
